...
pub struct NovitaModelConfig {
    ...
    pub key_var: String,
    #[serde(default = "default_novita_api_url")]
    pub api_url: Option<String>,
    #[serde(default)]
    pub headers: Option<HashMap<String, HeaderValue>>,
}

impl NovitaModelConfig {
...
/// Default Novita API URL
pub const NOVITA_API_URL: &str = "https://api.novita.ai/openai";

/// Returns the default Novita API URL for serde defaults
pub fn default_novita_api_url() -> Option<String> {
    Some(NOVITA_API_URL.to_string())
}
