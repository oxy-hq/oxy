...
use crate::a2a::{
    agent_card::AgentCardService, config::A2aConfig, handler::OxyA2aHandler,
    storage::OxyTaskStorage,
};
...
async fn create_a2a_application(
    ...
    project_manager: Arc<crate::adapters::project::manager::ProjectManager>,
    base_url: String,
