...
use crate::config::model::{Automation, Condition, ConditionalTask, SQL, Task, TaskType};
use oxy_shared::errors::OxyError;

impl TemplateRegister for Automation {
...
impl TemplateRegister for &Task {
    fn register_template(&self, renderer: &Renderer) -> Result<(), OxyError> {
        match &self.task_type {
            ...
            TaskType::SubAutomation(_sub_automation_task) => {
                // SubAutomationTask doesn't have file templates to register
            }
