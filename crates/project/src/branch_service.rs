...
impl BranchService {
    ...
    pub async fn get_revision_info(
        ...
        Ok(RevisionInfoResponse {
            ...
            latest_revision: latest_hash.clone(),
            current_commit: format!("{} - {}", current_commit.sha, current_commit.message),
            latest_commit: format!("{} - {}", latest_commit.sha, latest_commit.message),
