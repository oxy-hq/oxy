                        ...
                        if let Output::Table(table) = &chunk.delta {
                            ...
                            let query_params =
                                self.current_omni_query.clone().unwrap_or_else(|| {
                                    oxy::types::tool_params::OmniQueryParams {
                                        fields: vec![],
                                        limit: None,
                                        sorts: None,
                                    }
                                ...
                                sorts
                                    ...
                                    .map(|(k, v)| {
                                        (
                                            k.clone(),
                                            match v {
                                                oxy::types::tool_params::OrderType::Ascending => {
                                                    "asc".to_string()
                                                }
                                                oxy::types::tool_params::OrderType::Descending => {
                                                    "desc".to_string()
                                                }
                                            },
                                        )
                            ...
                            self.stream_dispatcher
                                .send_artifact_value(
                                    ...
                                    ArtifactValue::OmniQuery(OmniQuery {
                                        ...
                                        is_result_truncated: is_truncated,
                                        topic: topic.clone(),
                                        fields: query_params.fields.clone(),
                                        limit: query_params.limit,
                                        sorts: sorts_map,
                                    }),
                                    &source.kind,
