...
pub async fn list_apps(
    ...
    // files. `compiled_reader` handles both the branch carve-out and
    // the `compile_boundary_disabled` kill switch internally; we just
    // pass the active branch hint along.
