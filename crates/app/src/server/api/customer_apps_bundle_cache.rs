//! In-memory LRU over customer-app bundle objects.
//!
...
use super::customer_apps_build_store::{self, BuildStoreError};
...
pub async fn get_or_fetch(
    ...
    match customer_apps_build_store::get_object(app_id, build_id, rel_path).await? {
        Some(bytes) => {
