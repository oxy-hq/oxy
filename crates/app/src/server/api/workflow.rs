...
use oxy_workflow::streaming_workflow_persister::StreamingWorkflowPersister;
...
pub struct GetWorkflowResponse {
    ...
    pub workflow: oxy::config::model::Workflow,
}
...
fn parse_workflow_events(
    ...
    use crate::server::service::types::content::ContentType;
    use crate::server::service::types::event::EventKind;
...
fn reconstruct_events_from_run_details(
    ...
    use crate::server::service::types::block::BlockKind;
    use crate::server::service::types::content::ContentType;
    use crate::server::service::types::event::EventKind;
    ...
    events.push(EventKind::WorkflowStarted {
        ...
        workflow_config: oxy::config::model::Workflow {
