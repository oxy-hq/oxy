...
- The cache-invalidation taxonomy + v2 durability mechanism design
  rationale both live in `internal-docs/agentic-browser-testing-spec.md`
  (Tier-2 is row `C2` in the cache-invalidation taxonomy section).
