...
import {
  ...
  useReplayStep,
  useStepStatus
} from "@/pages/automation/components/RunStatusContext";
import type { NodeData, NodeType } from "@/stores/useAutomation";
...
export function DiagramNode({
  ...
  // Status + replay both come from the automation run page's
  // `RunStatusProvider`. The legacy `useAutomationRun` / `useTaskRun`
  // fallbacks were only reachable from `AutomationPreview`, which is
  // gone; the new `Automation` component always mounts the provider.
