...
const cleanFormData = (
  ...
  return (
    (cleanObject(data as Record<string, unknown>) as Partial<AgentFormData>) ||
    {}
  );
};
...
const getDefaultData = (data?: Partial<AgentFormData>) => {
  ...
  const isRoutingAgent =
    data?.routes && Array.isArray(data.routes) && data.routes.length > 0;
  ...
  if (data.system_instructions !== undefined)
    result.system_instructions = data.system_instructions;
  if (data.max_tool_calls !== undefined)
    result.max_tool_calls = data.max_tool_calls;
  ...
  if (data.route_fallback !== undefined)
    result.route_fallback = data.route_fallback;
  ...
  if (data.synthesize_results !== undefined)
    result.synthesize_results = data.synthesize_results;
