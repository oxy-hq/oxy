    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This action will pull the latest from the remote repository. This action cannot be
            undone. After pull success, the app will reload to reflect the latest changes.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
