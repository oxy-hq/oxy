 ...
 *
 * Reads `LiveIteration[]` published by `useWorkflowRunStream`'s
 * reducer (driven by the `subrun_step_iteration_started` /
 * `subrun_step_iteration_completed` events the workflow decider
...
type Props = {
  ...
  /**
   * Total iteration count if known from the workflow config. When
