...
export const MetricsForm: React.FC<MetricsFormProps> = ({ testIndex }) => {
  const {
    register,
    control,
    watch,
  ...
  const metrics = (watch(`tests.${testIndex}.metrics`) as unknown[]) || [];

  const addMetric = () => {
    const currentMetrics = (getValues(`tests.${testIndex}.metrics`) as unknown[]) || [];
    const newMetric = {
      type: "similarity",
    };
    const newIndex = currentMetrics.length;
    setValue(`tests.${testIndex}.metrics`, [...currentMetrics, newMetric]);
  ...
  const removeMetric = (metricIndex: number) => {
    ...
    setValue(`tests.${testIndex}.metrics`, updatedMetrics);
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                {...register(`${fieldPrefix}.model_ref` as any)}
              />
            </div>
            <div className="space-y-2">
              ...
              <Textarea
                ...
                {...register(`${fieldPrefix}.prompt` as any, {
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    step="0.1"
                    defaultValue="1.0"
                    {...register(`${fieldPrefix}.scores.A` as any, {
                      valueAsNumber: true,
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    step="0.1"
                    defaultValue="0.0"
                    {...register(`${fieldPrefix}.scores.B` as any, {
                      valueAsNumber: true,
        ...
        return (
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Controller
                name={`${fieldPrefix}.distance.distance` as any}
                control={control}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                step="0.1"
                defaultValue="0.5"
                {...register(`${fieldPrefix}.threshold` as any, {
                  valueAsNumber: true,
  ...
  return (
    <div className="space-y-4 border-t pt-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Configure evaluation metrics for this test. Default similarity metrics will be used if none are specified.
          </p>
        </div>
        <Button
          type="button"
      ...
      {metrics.map((_metric, metricIndex) => {
        const metricType = watch(`tests.${testIndex}.metrics.${metricIndex}.type`) as string | undefined;
              ...
              <CollapsibleContent className="space-y-4 mt-4">
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Controller
                      name={`tests.${testIndex}.metrics.${metricIndex}.type` as any}
                      control={control}
