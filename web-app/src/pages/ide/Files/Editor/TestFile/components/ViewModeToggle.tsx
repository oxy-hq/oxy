...
interface ViewModeToggleProps {
  viewMode: TestFileViewMode;
  onViewModeChange: (mode: TestFileViewMode) => void;
      ...
      {validationError ? (
        ...
        <Tabs
          ...
          onValueChange={(value: string) => {
            if (value === TestFileViewMode.Form || value === TestFileViewMode.Editor) {
              onViewModeChange(value as TestFileViewMode);
            }
          }}
        >
          <TabsList>
