        ...
        <div className='space-y-3'>
          {topClusters.map((cluster, index) => (
            <div key={cluster.intentName} className='flex items-center gap-3'>
              <div
                className='flex h-6 w-6 shrink-0 items-center justify-center rounded-md font-semibold text-xs'
                style={{
              ...
              <div className='min-w-0 flex-1'>
                <div className='mb-1 flex items-center justify-between'>
                  <span className='truncate font-medium text-sm'>{cluster.intentName}</span>
          ...
          {topClusters.length === 0 && !isLoading && (
            <p className='py-2 text-center text-muted-foreground text-sm'>No clusters found</p>
          )}
        </div>
