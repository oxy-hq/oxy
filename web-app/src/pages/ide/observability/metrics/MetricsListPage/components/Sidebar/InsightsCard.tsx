...
export default function InsightsCard({
  ...
  const popularPercentage =
    mostPopularCount && totalUsage > 0
      ? Math.round((mostPopularCount / totalUsage) * 100)
      : 0;
          ...
          <>
            {mostPopular && (
              <p className="text-muted-foreground">
                ...
                is your most queried metric, appearing in {popularPercentage}%
                of all analytics requests.
              </p>
            )}
            <p className="text-muted-foreground">
              {agentPercentage > 50
