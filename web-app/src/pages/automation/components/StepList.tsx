/**
 * Step list for a automation run — vertical layout with status indicators
 * and a small grey dot on cache-hit rows.
 *
 * Intentionally minimal: this is the v1 of the new agentic-automations page
...
import type { RunStepState } from "@/hooks/api/agentic-automations/useAgenticAutomations";
