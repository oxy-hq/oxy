export type WorkspaceType = "new" | "github" | "demo";
  ...
  const workspaceOptions = [
    {
      ...
      description: "Create a new workspace from scratch with agent, warehouse, and model settings.",
      icon: (
        <svg
    ...
    },
    {
      ...
      description: "Get started quickly with a pre-configured demo project.",
      icon: (
        <svg
          xmlns='http://www.w3.org/2000/svg'
          className='h-5 w-5 text-primary'
