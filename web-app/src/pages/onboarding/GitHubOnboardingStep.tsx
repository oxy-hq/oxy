              ...
              <div className='min-w-0 flex-1'>
                ...
                {installAppUrl && (
                  <a
                    ...
                    target='_blank'
                    rel='noreferrer'
                    className='mt-1 inline-block text-amber-700 text-xs underline underline-offset-2 hover:text-amber-900 dark:text-amber-400 dark:hover:text-amber-200'
                  >
                    Reinstall GitHub App to grant repository access
                  </a>
                )}
              </div>
            </div>
