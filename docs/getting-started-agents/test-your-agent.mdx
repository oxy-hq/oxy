...
<Info>
**See the default logic:** The built-in consistency evaluator uses a detailed prompt optimized for data analysis. You can view the [full default prompt](https://github.com/oxy-hq/oxy-internal/blob/main/crates/core/src/config/constants.rs#L52-L159) to understand exactly how it evaluates consistency.
</Info>
