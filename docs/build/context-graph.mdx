...
The **Context Graph** is an interactive graph-based visualization and navigation tool that maps all semantic and operational assets in your Oxygen project and their relationships. It provides a complete, visual understanding of how data flows through your system by showing connections between data assets, automations, and AI agents.

# What is the Context Graph?

The Context Graph feature creates a visual knowledge graph of your entire Oxygen project, displaying:
...
| `agent`      | AI agents                                          | Color-coded node      |
...
The Context Graph builds upon Oxygen's semantic layer concepts:
...
Navigate to the Context Graph page in the Oxygen IDE to see the interactive graph visualization of your project.
...
4. **Agent**: `customer_agent.agentic.yml` has access to `customer_analytics` topic
...
The Context Graph is your visual map to understanding, navigating, and maintaining your Oxygen data project. It transforms abstract configurations into a concrete, explorable graph that makes complex relationships immediately clear.
