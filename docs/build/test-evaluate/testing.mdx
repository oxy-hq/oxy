...
Consistency tests evaluate whether your agent produces **factually consistent** results across multiple runs. Since Oxygen is primarily used for **data analysis** (not general factual Q&A), the consistency evaluator is optimized for numerical data and analytical insights.
...
You can view the [default CONSISTENCY_PROMPT source](https://github.com/oxy-hq/oxygen-internal/blob/main/crates/core/src/config/constants.rs#L52-L199), copy it, and modify the specific rules you need:
