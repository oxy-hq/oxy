...
Models live alongside your agents, procedures, and apps in the same workspace. Like everything else in Oxygen, they are version-controlled YAML + SQL files that can be edited in the IDE, validated with `oxy validate`, and deployed through the standard Git workflow.
