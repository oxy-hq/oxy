...
<Note>
  ...
  Model](/build/semantic-layer/simple-model) for a lighter-weight alternative.
</Note>
...
[Learn more about Views →](/build/semantic-layer/views)
...
[Learn more about Entities →](/build/semantic-layer/entities)
...
[Learn more about Dimensions →](/build/semantic-layer/dimensions)
...
[Learn more about Measures →](/build/semantic-layer/measures)
...
[Learn more about Topics →](/build/semantic-layer/topics)
...
<CardGroup cols={2}>
  <Card
    title="Views"
    icon="database"
    href="/build/semantic-layer/views"
  >
  ...
  <Card
    title="Entities"
    icon="link"
    href="/build/semantic-layer/entities"
  >
  ...
  <Card
    title="Dimensions"
    icon="grid"
    href="/build/semantic-layer/dimensions"
  >
  ...
  <Card
    title="Measures"
    icon="chart-line"
    href="/build/semantic-layer/measures"
  >
  ...
  <Card
    title="Topics"
    icon="folder"
    href="/build/semantic-layer/topics"
  >
  ...
  <Card
    title="Usage"
    icon="rocket"
    href="/build/semantic-layer/use-in-agents"
  >
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="file-code"
    href="/build/semantic-layer/simple-model"
  >
    Simpler semantic model format
  </Card>
  <Card title="Context" icon="database" href="/build/agents/provide-context">
    Providing context to agents
  </Card>
  <Card title="Data Sources" icon="plug" href="/build/connect-data">
...
<CardGroup cols={2}>
  ...
  <Card title="Testing" icon="flask" href="/build/test-evaluate/testing">
