...
The semantic layer in Oxygen is a powerful abstraction that transforms raw database schemas into business-friendly concepts. It provides a declarative way to define business logic, metrics, and relationships that AI agents can understand and use to answer analytical questions accurately.
...
<Note>
  Oxygen also supports a simpler semantic model format (`.schema.yml`) for
  straightforward use cases. See [Semantic
  Model](/guide/build/semantic-layer/simple-model) for a lighter-weight alternative.
</Note>
...
[Learn more about Views →](/guide/build/semantic-layer/views)
...
[Learn more about Entities →](/guide/build/semantic-layer/entities)
...
[Learn more about Dimensions →](/guide/build/semantic-layer/dimensions)
...
[Learn more about Measures →](/guide/build/semantic-layer/measures)
...
[Learn more about Topics →](/guide/build/semantic-layer/topics)
...
```yaml agents/analyst.agentic.yml
...
<CardGroup cols={2}>
  <Card
    title="Views"
    icon="database"
    href="/guide/build/semantic-layer/views"
  >
  ...
  <Card
    title="Entities"
    icon="link"
    href="/guide/build/semantic-layer/entities"
  >
  ...
  <Card
    title="Dimensions"
    icon="grid"
    href="/guide/build/semantic-layer/dimensions"
  >
  ...
  <Card
    title="Measures"
    icon="chart-line"
    href="/guide/build/semantic-layer/measures"
  >
  ...
  <Card
    title="Topics"
    icon="folder"
    href="/guide/build/semantic-layer/topics"
  >
  ...
  <Card
    title="Usage"
    icon="rocket"
    href="/guide/build/semantic-layer/use-in-agents"
  >
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="file-code"
    href="/guide/build/semantic-layer/simple-model"
  >
    Simpler semantic model format
  </Card>
  <Card title="Context" icon="database" href="/guide/build/agents/provide-context">
    Providing context to agents
  </Card>
  <Card title="Data Sources" icon="plug" href="/guide/build/connect-data">
...
<CardGroup cols={2}>
  ...
  <Card title="Testing" icon="flask" href="/guide/build/test-evaluate/testing">
