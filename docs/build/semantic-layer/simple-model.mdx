...
<Note>
  ...
  documentation](/build/semantic-layer) for an alternative way to
...
For more information, refer to context objects in the [Agents](/build/agents#context) documentation.
