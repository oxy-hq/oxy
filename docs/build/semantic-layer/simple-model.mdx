...
<Note>
  Oxygen also supports a more structured semantic layer approach using views and
  topics. See the [Semantic Layer
  documentation](/guide/build/semantic-layer) for an alternative way to
...
```yaml data/anon_youtube.schema.yml
...
For more information, refer to context objects in the [Agents](/guide/build/agents#context) documentation.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="layer-group"
    href="/guide/build/semantic-layer"
  >
