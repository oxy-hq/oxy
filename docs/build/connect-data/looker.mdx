---
title: "Looker"
description: "Connect Oxygen to Looker for querying explores and syncing metadata"
---
...
Oxygen integrates with [Looker](https://cloud.google.com/looker) to enable agents and procedures to query Looker explores directly. The integration supports metadata synchronization, LLM-powered query generation, and procedure automation.
