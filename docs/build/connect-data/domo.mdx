...
[`~/.config/oxy/config.yml` file](/reference/yaml/config).  
...
- For semantic layer queries, Oxygen automatically maps Domo to Postgres compatibility and uses the `dataset_id` as the table identifier.
