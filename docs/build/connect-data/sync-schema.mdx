...
description: Learn how to synchronize database schema information with the Oxygen sync command
---
...
The `oxy sync` command collects semantic information from your databases and stores it in your local repository for use by agents and other Oxygen features. This semantic information includes table structures, relationships, and sample data that help agents understand your data model.
...
When you run the `oxy sync` command, Oxygen will:
...
See the [configuration documentation](/guide/reference/yaml/config) for more details on setting up your database connections.
