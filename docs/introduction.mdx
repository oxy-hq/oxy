...
- `./agents`: Configuration files that define the agents _in plain yaml_. Each
...
Data agents can be interfaced with directly using the `onyx run path/to/agent.agent.yml "<question>"`
