  ...
  if (typeof window === "undefined") {
    ...
    setTimeout(() => {
      ...
      const linkMap = {
        ...
        "macos_x64": "https://github.com/oxy-hqoxy/releases/latest/download/oxy_x64.dmg",
        "macos_arm": "https://github.com/oxy-hqoxy/releases/latest/download/oxy_aarch64.dmg"
      };
