export const DownloadLink = () => {
  if (typeof window === "undefined") {
    ...
    setTimeout(() => {
      ...
      const linkMap = {
        "windows_x64": "https://github.com/onyx-hq/onyx-public-releases/releases/latest/download/onyx_x64.zip",
        "macos_x64": "https://github.com/onyx-hq/onyx-public-releases/releases/latest/download/onyx_x64.dmg",
        "macos_arm": "https://github.com/onyx-hq/onyx-public-releases/releases/latest/download/onyx_aarch64.dmg"
      };
