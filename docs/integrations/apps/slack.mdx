...
<Info>
  For local development, you can use a tunneling service like
  [ngrok](https://ngrok.com) to expose your local Oxy instance.
</Info>
...
<Info>
  If you're not a workspace admin, you'll see **Request to Install** instead. A
  workspace admin will need to approve the request.
</Info>
...
<Frame>
  <img
    src="../../../images/slack-agent-preferences.png"
    alt="Slack Preferences showing App agents & assistants settings"
  />
</Frame>
...
<Info>
  For more details, see [Slack's documentation on AI
  apps](https://slack.com/help/articles/33076000248851-Understand-AI-apps-in-Slack).
</Info>
