...
You can see a complete example in [crates/core/demo_project/v0.agent.yml](../../../crates/core/demo_project/v0.agent.yml).
...
**Solution**: Ensure your agent's system instructions include guidance to prompt v0 with SDK usage instructions. See the example in [crates/core/demo_project/v0.agent.yml:108](../../../crates/core/demo_project/v0.agent.yml#L108).
...
- Explore the [complete v0 agent example](../../../crates/core/demo_project/v0.agent.yml)
