...
See the [Environment Variables Reference](/manage/secrets) for complete documentation.
...
[Branch Configuration reference](/manage/workspaces/branches) for details.

## Additional Resources

To get more information about connecting to databases or models, you can reference our [integrations](/build/connect-data) section.
