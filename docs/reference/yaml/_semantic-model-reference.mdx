---
title: "Semantic Model Quick Reference"
description: "Quick reference for semantic model syntax and properties"
---
...
- [Semantic Model Guide](/guide/build/semantic-model/simple-model) - Complete documentation
- [Agents](/guide/build/agents) - Using semantic model with agents
- [Context](/guide/build/agents/provide-context) - Providing context to agents
