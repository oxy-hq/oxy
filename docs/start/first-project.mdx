...
<Steps>
  ...
  <Step title="Connect a model">
    ...
    [Manage → Secrets](/guide/manage/secrets).
  ...
  <Step title="Connect a data source">
    ...
    See [Connect your data](/guide/start/connect-your-data) for the full
...
Now you're ready to [build your first agent](/guide/start/first-agent), or
let the Builder copilot do it for you in
[Build with chat first](/guide/start/build-with-chat).
