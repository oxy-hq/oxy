...
4. **Cloud Mode** - Deploy Oxy as a [multi-tenant cloud platform](/deployment/cloud-mode) using `oxy serve --cloud --enterprise`. Projects are synced from GitHub repositories and managed through workspaces.
