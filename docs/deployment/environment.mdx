...
| `GITHUB_STATE_SECRET` | For GitHub import | Random secret for HMAC-signing OAuth state tokens |
| `GITHUB_APP_INSTALLATION_ID` | No | Pre-configure a specific installation to skip the connect dialog |
