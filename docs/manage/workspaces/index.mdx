...
3. Set protected branches and a base branch — see
   [Branch-aware editing](/manage/workspaces/branches).

[Full guide →](/manage/workspaces/github-integration)
...
<CardGroup cols={2}>
  ...
  <Card title="Branch-aware editing" href="/manage/workspaces/branches" />
  <Card title="GitHub integration" href="/manage/workspaces/github-integration" />
