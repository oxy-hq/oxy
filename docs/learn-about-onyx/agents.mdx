...
| data                | `./data` sub-directories accessible to the agent (see [data](/learn-about-onyx/data))             | required |
| warehouse           | Warehouse to use (defined in [config.yml](/learn-about-onyx/config), referenced by `name`)        | required |
