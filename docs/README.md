...
The build happens automatically as part of the Oxy Content CI CD Pipeline. It does not happen within this repository. For more information, please visit [the Oxy Content repository](https://github.com/oxy-hq/oxygen-content).
...
- To deploy the doc to `oxygen-hq.com/changelog`, trigger the workflow in the [Oxy Content repository](https://github.com/oxy-hq/oxygen-content)
