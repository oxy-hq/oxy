...
<Note>
  Oxy also supports a more structured semantic layer approach using views and topics. See the [Semantic Layer documentation](/learn-about-oxy/semantic-layer) for an alternative way to organize your semantic definitions.
</Note>
