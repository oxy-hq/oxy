...
<CardGroup cols={2}>
  ...
  <Card
    title="Measures"
    icon="chart-line"
    href="/learn-about-oxy/semantic-layer/measures"
  >
  ...
  <Card
    title="Usage"
    icon="rocket"
    href="/learn-about-oxy/semantic-layer/usage"
  >
...
<CardGroup cols={2}>
  <Card
    ...
    icon="book"
    href="/reference/semantic-layer-reference"
  >
  ...
  <Card
    ...
    icon="file-code"
    href="/learn-about-oxy/semantic-model"
  >
